...
public class StateCensusAnalyserTest {
    ...
    public static final String STATECENSUS_CSVFILE = "D:\\Ge_Assignments\\censusAnalyser\\state_census_analyzer\\src\\main\\resources\\StateCensusData.csv";
    ...
    @Test
    public void TestIncorrectFileExtension() throws IOException {
        try {
    ...
    @Test
    public void TestIncorrectDelimiter() throws IOException {
        try {
            int count = StateCensusAnalyser.openCsvBuilder(STATECENSUS_CSVFILE, StateCensus.class);
        } catch (CensusAnalyserException e) {
            e.printStackTrace();
